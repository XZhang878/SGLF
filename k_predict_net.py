...
class EncoderLayer(nn.Module):
    ...
    def forward(self, row_emb, col_emb, cost_mat):
        ...
        # col_emb.shape: (batch, col_cnt, embedding)
        # cost_mat.shape: (batch, row_cnt, col_cnt)
        cost_mat = cost_mat.reshape(1, cost_mat.size(0), cost_mat.size(1))
...
def reshape_by_heads(qkv, head_num):
    ...
    # q_reshaped = qkv.reshape(batch_s, head_num, -1)
    # q_reshaped = qkv.reshape(batch_s, 1, head_num, -1)
    q_reshaped = qkv.reshape(1, batch_s, head_num, -1)
